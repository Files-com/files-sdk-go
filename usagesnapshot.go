...
type UsageSnapshot struct {
	...
	TotalBillableTransferUsage   int64                    `json:"total_billable_transfer_usage,omitempty" path:"total_billable_transfer_usage,omitempty" url:"total_billable_transfer_usage,omitempty"`
