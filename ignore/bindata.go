...
func ignoreDataLinuxGitignore() (*asset, error) {
	...
	info := bindataFileInfo{name: "ignore/data/Linux.gitignore", size: 316, mode: os.FileMode(420), modTime: time.Unix(1628266048, 0)}
...
func ignoreDataWindowsGitignore() (*asset, error) {
	...
	info := bindataFileInfo{name: "ignore/data/Windows.gitignore", size: 290, mode: os.FileMode(420), modTime: time.Unix(1628266048, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func ignoreDataMacosGitignore() (*asset, error) {
	...
	info := bindataFileInfo{name: "ignore/data/macOS.gitignore", size: 402, mode: os.FileMode(420), modTime: time.Unix(1628266048, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
