...
type HistoryExport struct {
  ...
  QueryUserId int `json:"query_user_id,omitempty"`
  QueryFileId int `json:"query_file_id,omitempty"`
  QueryParentId int `json:"query_parent_id,omitempty"`
  ...
  QueryTargetId int `json:"query_target_id,omitempty"`
  ...
  QueryTargetUserId int `json:"query_target_user_id,omitempty"`
...
type HistoryExportCreateParams struct {
  ...
  QueryUserId int `url:"query_user_id,omitempty"`
  QueryFileId int `url:"query_file_id,omitempty"`
  QueryParentId int `url:"query_parent_id,omitempty"`
