...
func TestHighThroughputUploadPlanLinux(t *testing.T) {
	...
	require.Contains(t, plan.UserSteps[2].Commands[0].CommandLine, "ulimit -Sn")
	require.Contains(t, plan.UserSteps[2].ExpectedOutcome, "Soft nofile")
...
func TestHighThroughputUploadPlanDarwin(t *testing.T) {
	...
	require.Contains(t, plan.UserSteps[1].Commands[0].CommandLine, "ulimit -Sn")
...
func TestHighThroughputUploadPlanDarwinNetworkQualityIsOptIn(t *testing.T) {
	...
	require.Contains(t, verificationSteps[2].Title, "Measure Apple network quality")
	require.NotContains(t, verificationSteps[2].Title, "before repair")
