...
type SiteGetParams struct {
	...
	Site   json.RawMessage `url:"site,omitempty"`
}
...
type SiteUpdateParams struct {
	...
	AllowBundleNames                     *bool     `url:"allow_bundle_names,omitempty"`
	BundleExpiration                     int       `url:"bundle_expiration,omitempty"`
	OverageNotify                        *bool     `url:"overage_notify,omitempty"`
	WelcomeEmailEnabled                  *bool     `url:"welcome_email_enabled,omitempty"`
	AskAboutOverwrites                   *bool     `url:"ask_about_overwrites,omitempty"`
	ShowRequestAccessLink                *bool     `url:"show_request_access_link,omitempty"`
	WelcomeEmailCc                       string    `url:"welcome_email_cc,omitempty"`
	WelcomeCustomText                    string    `url:"welcome_custom_text,omitempty"`
	Language                             string    `url:"language,omitempty"`
	WindowsModeFtp                       *bool     `url:"windows_mode_ftp,omitempty"`
	DefaultTimeZone                      string    `url:"default_time_zone,omitempty"`
	DesktopApp                           *bool     `url:"desktop_app,omitempty"`
	DesktopAppSessionIpPinning           *bool     `url:"desktop_app_session_ip_pinning,omitempty"`
	DesktopAppSessionLifetime            int       `url:"desktop_app_session_lifetime,omitempty"`
	FolderPermissionsGroupsOnly          *bool     `url:"folder_permissions_groups_only,omitempty"`
	WelcomeScreen                        string    `url:"welcome_screen,omitempty"`
	OfficeIntegrationAvailable           *bool     `url:"office_integration_available,omitempty"`
	SessionExpiry                        float32   `url:"session_expiry,omitempty"`
	SslRequired                          *bool     `url:"ssl_required,omitempty"`
	TlsDisabled                          *bool     `url:"tls_disabled,omitempty"`
	UserLockout                          *bool     `url:"user_lockout,omitempty"`
	UserLockoutTries                     int       `url:"user_lockout_tries,omitempty"`
	UserLockoutWithin                    int       `url:"user_lockout_within,omitempty"`
	UserLockoutLockPeriod                int       `url:"user_lockout_lock_period,omitempty"`
	IncludePasswordInWelcomeEmail        *bool     `url:"include_password_in_welcome_email,omitempty"`
	AllowedIps                           string    `url:"allowed_ips,omitempty"`
	DaysToRetainBackups                  int       `url:"days_to_retain_backups,omitempty"`
	MaxPriorPasswords                    int       `url:"max_prior_passwords,omitempty"`
	PasswordValidityDays                 int       `url:"password_validity_days,omitempty"`
	PasswordMinLength                    int       `url:"password_min_length,omitempty"`
	PasswordRequireLetter                *bool     `url:"password_require_letter,omitempty"`
	PasswordRequireMixed                 *bool     `url:"password_require_mixed,omitempty"`
	PasswordRequireSpecial               *bool     `url:"password_require_special,omitempty"`
	PasswordRequireNumber                *bool     `url:"password_require_number,omitempty"`
	PasswordRequireUnbreached            *bool     `url:"password_require_unbreached,omitempty"`
	SftpUserRootEnabled                  *bool     `url:"sftp_user_root_enabled,omitempty"`
	DisablePasswordReset                 *bool     `url:"disable_password_reset,omitempty"`
	ImmutableFiles                       *bool     `url:"immutable_files,omitempty"`
	SessionPinnedByIp                    *bool     `url:"session_pinned_by_ip,omitempty"`
	BundlePasswordRequired               *bool     `url:"bundle_password_required,omitempty"`
	PasswordRequirementsApplyToBundles   *bool     `url:"password_requirements_apply_to_bundles,omitempty"`
	OptOutGlobal                         *bool     `url:"opt_out_global,omitempty"`
	UseProvidedModifiedAt                *bool     `url:"use_provided_modified_at,omitempty"`
	CustomNamespace                      *bool     `url:"custom_namespace,omitempty"`
	DisableUsersFromInactivityPeriodDays int       `url:"disable_users_from_inactivity_period_days,omitempty"`
	NonSsoGroupsAllowed                  *bool     `url:"non_sso_groups_allowed,omitempty"`
	NonSsoUsersAllowed                   *bool     `url:"non_sso_users_allowed,omitempty"`
	SharingEnabled                       *bool     `url:"sharing_enabled,omitempty"`
	UserRequestsEnabled                  *bool     `url:"user_requests_enabled,omitempty"`
	Allowed2faMethodSms                  *bool     `url:"allowed_2fa_method_sms,omitempty"`
	Allowed2faMethodU2f                  *bool     `url:"allowed_2fa_method_u2f,omitempty"`
	Allowed2faMethodTotp                 *bool     `url:"allowed_2fa_method_totp,omitempty"`
	Allowed2faMethodYubi                 *bool     `url:"allowed_2fa_method_yubi,omitempty"`
	Require2fa                           *bool     `url:"require_2fa,omitempty"`
	Require2faUserType                   string    `url:"require_2fa_user_type,omitempty"`
	Color2Top                            string    `url:"color2_top,omitempty"`
	Color2Left                           string    `url:"color2_left,omitempty"`
	Color2Link                           string    `url:"color2_link,omitempty"`
	Color2Text                           string    `url:"color2_text,omitempty"`
	Color2TopText                        string    `url:"color2_top_text,omitempty"`
	SiteHeader                           string    `url:"site_header,omitempty"`
	SiteFooter                           string    `url:"site_footer,omitempty"`
	LoginHelpText                        string    `url:"login_help_text,omitempty"`
	SmtpAddress                          string    `url:"smtp_address,omitempty"`
	SmtpAuthentication                   string    `url:"smtp_authentication,omitempty"`
	SmtpFrom                             string    `url:"smtp_from,omitempty"`
	SmtpUsername                         string    `url:"smtp_username,omitempty"`
	SmtpPort                             int       `url:"smtp_port,omitempty"`
	LdapEnabled                          *bool     `url:"ldap_enabled,omitempty"`
	LdapType                             string    `url:"ldap_type,omitempty"`
	LdapHost                             string    `url:"ldap_host,omitempty"`
	LdapHost2                            string    `url:"ldap_host_2,omitempty"`
	LdapHost3                            string    `url:"ldap_host_3,omitempty"`
	LdapPort                             int       `url:"ldap_port,omitempty"`
	LdapSecure                           *bool     `url:"ldap_secure,omitempty"`
	LdapUsername                         string    `url:"ldap_username,omitempty"`
	LdapUsernameField                    string    `url:"ldap_username_field,omitempty"`
	LdapDomain                           string    `url:"ldap_domain,omitempty"`
	LdapUserAction                       string    `url:"ldap_user_action,omitempty"`
	LdapGroupAction                      string    `url:"ldap_group_action,omitempty"`
	LdapUserIncludeGroups                string    `url:"ldap_user_include_groups,omitempty"`
	LdapGroupExclusion                   string    `url:"ldap_group_exclusion,omitempty"`
	LdapGroupInclusion                   string    `url:"ldap_group_inclusion,omitempty"`
	LdapBaseDn                           string    `url:"ldap_base_dn,omitempty"`
	Icon16File                           io.Writer `url:"icon16_file,omitempty"`
	Icon16Delete                         *bool     `url:"icon16_delete,omitempty"`
	Icon32File                           io.Writer `url:"icon32_file,omitempty"`
	Icon32Delete                         *bool     `url:"icon32_delete,omitempty"`
	Icon48File                           io.Writer `url:"icon48_file,omitempty"`
	Icon48Delete                         *bool     `url:"icon48_delete,omitempty"`
	Icon128File                          io.Writer `url:"icon128_file,omitempty"`
	Icon128Delete                        *bool     `url:"icon128_delete,omitempty"`
	LogoFile                             io.Writer `url:"logo_file,omitempty"`
	LogoDelete                           *bool     `url:"logo_delete,omitempty"`
	Disable2faWithDelay                  *bool     `url:"disable_2fa_with_delay,omitempty"`
	LdapPasswordChange                   string    `url:"ldap_password_change,omitempty"`
	LdapPasswordChangeConfirmation       string    `url:"ldap_password_change_confirmation,omitempty"`
	SmtpPassword                         string    `url:"smtp_password,omitempty"`
}
